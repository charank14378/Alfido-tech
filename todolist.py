...
class todo:
    def __init__(self, root):
        ...
        self.label=Label(self.root, text='To-Do-List-App',
                         font='opensans, 25 bold',width=10,bd=5,bg='orange',fg='black')
        self.label.pack(side='top',fill=BOTH)
        self.label2=Label(self.root, text='Add Task',
                         font='opensans, 19 bold',width=10,bd=5,bg='orange',fg='black')
        self.label2.place(x=40,y=55)
        self.label3=Label(self.root, text=' Tasks',
                         font='opensans, 19 bold',width=10,bd=5,bg='orange',fg='black')
        self.label3.place(x=320,y=55)
        self.main_text=Listbox(self.root,height=9,bd=5,width=23,font="opensans, 20 italic bold")
        self.main_text.place(x=280,y=100)
        self.text=Text(self.root,bd=5,height=2,width=30,font='opensans, 10 bold')
        ...
        self.button=Button(self.root,text="Add",font='sarif, 20 bold italic',
                           width=10,bd=5,bg='white',fg='black',command=add)
        self.button.place(x=30,y=180)
        self.button2=Button(self.root,text="Delete",font='sarif, 20 bold italic',
                           width=10,bd=5,bg='white',fg='black',command=delete)
